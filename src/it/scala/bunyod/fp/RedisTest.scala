...
//import bunyod.fp.infrastructure.redis.{LiveAuthRepository, LiveShoppingCart}
//import bunyod.fp.itsuite.{IOAssertion, ResourceSuite}
//import bunyod.fp.utils.cfg.Configuration.{ShoppingCartCfg, TokenExpirationCfg}
//import cats.Eq
...
//  lazy val tokenConfig = JwtSecretKey(Secret("bar": NonEmptyString))
...
//        IOAssertion {
//          for {
//            t <- Live.make[IO](tokenConfig, tokenExp)
//            a <- LiveAuthRepository.make(tokenExp, t, new TestUsers(un2), cmd)
